---
title: "Yoke-RGBW"
description: "Yoke-RGBW RGBW Lighting Module"
tags: "Yoke, LEDs, RGBW"
published: true
isPublished: true
---
<div style="display: flex; align-items: center; gap: 15px; margin: 15px 0; padding: 15px; background: #f7f7f7; border-radius: 16px; ">
  <div style="flex: 0 0 30%;"><img src="https://res.8ms.xyz/ryzobee/wiki/Yoke/Yoke_RGBW_Wiki_main.png" alt="RootMaker" style=" width: 100%; display: block; border-radius: 12px;"></div>
  <div style="flex: 1;">
    <h1 style="margin: 0 15px 12px 0;">Yoke-RGBW RGBW Lighting Module</h1>
    <p style="margin: 0 15px 12px 0; line-height: 1.7;">
	Yoke-RGBW is an RGBW lighting module designed for 3D-printed creations, including illuminated models, status indicators, mood lighting, interactive installations, and desktop ornaments.  
...
Yoke-RGBW integrates an RGBW LED with an independent white channel in addition to standard RGB, providing more natural white light, softer fill lighting, and richer color mixing.
...
- One LED with four-channel RGBW lighting
...
Before using Yoke-RGBW, make sure the Root controller is flashed with firmware or a project template that supports RGBW lighting control.

### Connect to a Root Controller
Yoke-RGBW connects to a Root controller with an RS-Port cable.

<div style="text-align: center;">
     <img src="https://res.8ms.xyz/ryzobee/wiki/Yoke/Yoke_RGBW_Wiki_connect2rootmaker.png" alt="RootMaker" style="width: 60%; height: auto; border-radius: 5px; margin-bottom: 10px;"> 
</div>
...
Yoke-RGBW can be installed inside a 3D-printed model, behind a translucent enclosure, beneath a light guide, or inside a lampshade.

The module supports daisy-chaining, as shown below.

<div style="text-align: center;">
     <img src="https://res.8ms.xyz/ryzobee/wiki/Yoke/Yoke_RGBW_Wiki_install.png" alt="RootMaker" style="width: 80%; height: auto; border-radius: 5px; margin-bottom: 10px;"> 
</div>
...
Yoke-RGBW power consumption depends on LED brightness, color, and use of the white channel.

| Item | MAX | Type | Min |
|---|---|---|---|
| Supply Current (mA) | 90mA | | |
...
<div style="text-align: center;">
    <img src="https://res.8ms.xyz/ryzobee/wiki/Yoke/Yoke_RGBW_Wiki_mechanical.png" alt="RootMaker" style="width: 80%; height: auto; border-radius: 5px; margin-bottom: 10px;"> 
</div>
...
<div style="display:flex;align-items:center;justify-content:space-between;gap:14px;margin:16px 0;padding:14px 16px;background:#fff;border:1px solid #e5e5e5;border-radius:10px;">
  <div style="display:flex;align-items:center;gap:12px;">
    ...
    <div>
      <div style="font-size:15px;font-weight:700;color:#222;">3D STEP File ZXYoke-RGBW.step</div>
      <div style="font-size:12px;color:#777;">STEP · V1.0 · 524 KB</div>
    </div>
  </div>
  <a href="https://res.8ms.xyz/ryzobee/wiki/Yoke/step_file/ZXYoke-RGBW.step" download style="padding:7px 13px;background:#ff6a00;color:#fff;text-decoration:none;border-radius:6px;font-size:13px;font-weight:700;white-space:nowrap;">Download</a>
</div>

## Frequently Asked Questions

### What if Yoke-RGBW does not light up?
